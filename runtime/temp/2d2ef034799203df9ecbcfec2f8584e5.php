<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\vhost\tpshop\public/../application/admin\view\attribute\getAttributeByType.html";i:1551928178;}*/ ?>
<?php
foreach ($data as $v) {
	if ($v["attr_type"]==1) {
...
<div class='formControls col-xs-8 col-sm-9'>
	<input type='text' id='goods-title' name='attr[".$v['id']."][]' placeholder='控制在25个字、50个字节以内' value='' class='input-text'>
</div>
</div>";
}else{
...
echo "<div class='row cl'>
	<label class='form-label col-xs-4 col-sm-2'>".
		$v['attr_name']."：</label>
	<div class='formControls col-xs-8 col-sm-9'>
		<input type='text' id='' name='attr[".$v['id']."][]' placeholder='控制在25个字、50个字节以内' value='' class='input-text'>
	</div>
</div>";
}else{
//手工录入
