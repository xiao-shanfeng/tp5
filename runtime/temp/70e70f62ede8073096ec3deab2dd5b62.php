<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\vhost\tpshop\public/../application/home\view\index\index.html";i:1552380893;}*/ ?>
<!DOCTYPE html>
<html>
					...
					<div class="shortcut">
						<ul class="fl">
							...
							<li class="f-item">
								...
								<?php echo session("user_name"); else: ?>
								请<a href="<?php echo url('home/user/login'); ?>" target="_blank">登录</a>　
								<span><a href="<?php echo url('home/user/register'); ?>" target="_blank">免费注册</a></span>
								<?php endif; ?>
							</li>
						</ul>
						<ul class="fr">
				...
				<div class="py-container">
					<div class="yui3-g Logo">
						...
						<div class="yui3-u Center searchArea">
							<div class="search">
								<form action="<?php echo url('home/category/index'); ?>" method="post" class="sui-form form-inline">
									<!--searchAutoComplete-->
									<div class="input-append">
										<input type="key" id="autocomplete" type="text" class="input-error input-xxlarge" />
						...
						<div class="yui3-u Right shopArea">
							<div class="fr shopcar">
								<div class="show-shopcar" id="shopcar">
									<span class="car"></span>
									<a class="sui-btn btn-default btn-xlarge" href="<?php echo url('home/shop/cartinfo'); ?>" target="_blank">
										<span>我的购物车</span>
										<i class="shopnum">0</i>
									</a>
						...
						<div class="all-sorts-list">
							...
							<div class="sort">
								<div class="all-sort-list2">
									<?php foreach($cateA as $a): ?>
									<div class="item bo">
										<h3><a href="<?php echo url('home/Category/index',['id'=>$a['id']]); ?>"><?php echo $a['cate_name']; ?></a></h3>
										<div class="item-list clearfix">
											<div class="subitem">
												<?php if(is_array($cateB) || $cateB instanceof \think\Collection || $cateB instanceof \think\Paginator): if( count($cateB)==0 ) : echo "" ;else: foreach($cateB as $k=>$b): if($b['parent_id'] == $a['id']): ?>
												<dl class="fore1">
													<dt><a href="<?php echo url('home/Category/index',['id'=>$b['id']]); ?>"><?php echo $b['cate_name']; ?></a></dt>
													<dd>
														<?php foreach($cateB as $c): if($c['parent_id'] == $b['id']): ?>
														<em><a href="<?php echo url('home/Category/index',['id'=>$c['id']]); ?>"><?php echo $c['cate_name']; ?></a></em>
