<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\vhost\tpshop\public/../application/home\view\category\index.html";i:1551968165;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="goods-list">
					<ul class="yui3-g">
						...
						<li class="yui3-u-1-5">
							<div class="list-wrap">
								<div class="p-img">
									<a href="<?php echo url('home/item/item',['id'=>$v['id']]); ?>" target="_blank"><img src="<?php echo $v['goods_thumb']; ?>" /></a>
								</div>
								<div class="price">
									<strong>
											<em>¥</em>
