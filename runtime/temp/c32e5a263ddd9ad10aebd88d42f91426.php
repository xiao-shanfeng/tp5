<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\vhost\tpshop\public/../application/home\view\item\item.html";i:1552045643;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="<?php echo $data['goods_ori']; ?>" src="<?php echo $data['goods_img']; ?>" /></span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									...
									<li><img src="<?php echo $v['album_img']; ?>" bimg="<?php echo $v['album_ori']; ?>" onmousemove="preview(this)" /></li>
									<?php endforeach; ?>
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="summary">
						<div class="summary-wrap">
							...
							<div class="fl price">
								<i>¥</i>
								<em><?php echo $data['shop_price']; ?></em>
								<span>降价通知</span>
							</div>
							<div class="fr remark">
					...
					<div class="clearfix choose">
						<form action="<?php echo url('home/Shop/add'); ?>" method="post">
							<input type="hidden" name="goods_id" value="<?php echo $data['id']; ?>">
							<div id="specification" class="summary-wrap clearfix">
								<?php foreach($attr as $v): if($v['attr_type'] == '1'): ?>
								<dl>
									<dt>
										<div class="fl title">
									...
									<dd style="display: inline;">
										<input type="radio" name="attr[<?php echo $v['id']; ?>]" <?php if($kk == '0'): ?>checked="checked"<?php endif; ?> value="<?php echo $vv; ?>"><?php echo $vv; ?>
									</dd>
									<?php endforeach; ?>
								</dl>
							...
							<div class="summary-wrap">
								<div class="fl title">
									<div class="control-group">
										<div class="controls">
											<input id="number" name="goods_buy_number" autocomplete="off" type="text" value="1" minnum="1" class="itxt" />
